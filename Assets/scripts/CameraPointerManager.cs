...
public class CameraPointerManager : MonoBehaviour
{
    ...
    private readonly string intaractableTag = "Intaractable";
    ...
    } // ✅ ← FALTABA cerrar el método Awake
    ...
    public void Update()
    {
        ...
        if (Physics.Raycast(transform.position, transform.forward, out hit, _maxDistance))
        {
            ...
            if (hit.transform.CompareTag(intaractableTag))
            {
        ...
        // Detecta pulsación del Cardboard
